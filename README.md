...
* A table that breaks down school performances based on average Spending Ranges (Per Student). I used 4 reasonable bins to group school spending. Include in each table are the following:
  * Average Math Score
  * Average Reading Score
  * % Passing Math (The percentage of students that passed math.)
  * % Passing Reading (The percentage of students that passed reading.)
...
* I provide the scores by school by repeating the above breakdown, but this time group schools based on a reasonable approximation of school size (Small, Medium, Large).

### Scores by School Type

* I repeat the above breakdown, but this time group schools based on school type (Charter vs. District).
